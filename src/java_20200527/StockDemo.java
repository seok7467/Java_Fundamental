...
public class StockDemo {
	...
	public static void main(String[] args) {
		...
		String url ="https://finance.naver.com/item/sise_day.nhn?code=096530";
		...
		try {
			...
			Elements trElements = doc.select(".type2 tbody tr");
			...
			for(int i =0; i<trElements.size();i++) {
				...
				String ratio = trElement.child(2).text();
				...
				System.out.println(date + "\t" + close + "\t" + ratio + "\t" + open + "\t" + high+ "\t" + low + "\t" + volume);
