...
public class UrlConnectionDemo {
	...
	public static void main(String[] args) throws IOException {
		...
		//URL클래스는 url 구성요소(protocol, host, port, path, query, reference)를 가져올 수 있고, url 자원(이미지, html)을 스트림으로 가져올 수 있다.
		URL url = new URL("https://www.naver.com/");
		
		//URLConnection 클래스는 url에 있는 원격 서버의 헤더 정보를 가져올 수 있고, url자원(이미지, html)을 스트림으로 가져올 수 있다.
